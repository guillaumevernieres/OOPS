...
//Log::debug() << "datetime_getints yy, mm, dd = " <<yy<<", "<<mm<<", "<<dd<<std::endl;
  date = 10000 * yy + 100 * mm + dd;
//Log::debug() << "datetime_getints hh, nn, ss = " <<hh<<", "<<nn<<", "<<ss<<std::endl;
...
void datetime_setints_f(util::DateTime * dt, const int64_t & date, const int & time) {
  ...
  mm = ii / 100;
  dd = ii % 100;
//Log::debug() << "datetime_setints yy, mm, dd = " <<yy<<", "<<mm<<", "<<dd<<std::endl;
