...
#ifndef OOPS_ASSIMILATION_BHESSIANMATRIX_H_
#define OOPS_ASSIMILATION_BHESSIANMATRIX_H_
...
template<typename MODEL> class BHessianMatrix : private boost::noncopyable {
 ...
 public:
  explicit BHessianMatrix(const CostFct_ & j): j_(j) {}
...
#endif  // OOPS_ASSIMILATION_BHESSIANMATRIX_H_
