...
#ifndef LORENZ95_L95TRAITFGAT_H_
#define LORENZ95_L95TRAITFGAT_H_
...
//  static const int nnn = 95;
  ...
  typedef lorenz95::IdTLM                  LinearModel;
...
const std::string L95TraitFGAT::nameCovar = "L95Error";

}  // namespace lorenz95

#endif  // LORENZ95_L95TRAITFGAT_H_
